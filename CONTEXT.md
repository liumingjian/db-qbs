...
　**2026-08-18 改判（[ADR-0036](docs/adr/0036-task-spec-structured.md)，实现尚未落地，
　以上描述的是现状）**：任务定义改为一份**结构化规格**（表、列、过滤条件、排序、主键），
...
　**2026-08-18 改判（[ADR-0035](docs/adr/0035-upsert-write-model.md) §3，实现尚未落地，
　以上描述的是现状）**：业务日期**不再是一等公民**，它降级为普通过滤条件之一
...
　**2026-08-18 退役（[ADR-0035](docs/adr/0035-upsert-write-model.md) §1，实现尚未落地）**：
...
　**2026-08-18 改判（[ADR-0036](docs/adr/0036-task-spec-structured.md) §5，实现尚未落地，
　以上描述的是现状）：整段退役。** SQL 不再可手改、改由规格生成之后，六条里三条随业务日期
