/**
 * 系统设置——导航第三项（ADR-0043 §2 的三项之一）。
 *
 * **本版它不可写，而且是有意的**：这一版能改的东西一共两类，都已经各有落点——
 * 连接信息在「数据源」屏（ADR-0037 §5），任务定义在作业中心的构建器里。
 * 剩下的是服务端进程级配置（Oracle 客户端库、sink 地址、监听地址、数据目录、
